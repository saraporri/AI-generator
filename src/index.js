...
function generateLyrics(event) {
  ...
  let context =
    "Please it should be just a verse, everything in basic HTML and separate each line with a <br/>. Include song title and artist at the end inside a <strong>. Make sure to follow the user instructions";
